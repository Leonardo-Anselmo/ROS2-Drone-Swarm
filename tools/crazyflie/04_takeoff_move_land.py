...
def main() -> int:
    ...
    try:
        with SyncCrazyflie(args.uri, cf=Crazyflie(rw_cache="./cache")) as scf:
            ...
            logconf.add_variable("stateEstimate.y", "float")        # Add the y position value for telemetry logging
            logconf.add_variable("stateEstimate.x", "float")        # Add the x position value for telemetry logging

            latest = {"vbat": None, "x": None, "y": None, "z": None}    # Add new logging parameters
            ...
            hlc.go_to(0.5, 0.0, 0.5, 0.0, 5.0)  # Tells the crazyflie to move to a location (x, y, z, yaw, t)
